...
public class CheckDigit
{
   ...
   {   
	...
	int leftDigit=0;
	int rightDigit=0;
	rightDigit=numWithCheckDigit%10;
	leftDigit=(numWithCheckDigit-rightDigit)/10;
	if (getCheck(leftDigit)==rightDigit){
		return true;
	}
   	return false;
   }
...
Create a private int incorrectCount above getCheck. Inside isValid after the end of the if statement and before the return false have
incorrectCount be incremented. This will result in a variable keeping track of the number of times isValid is false.
